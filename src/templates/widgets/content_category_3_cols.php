...
class ANRed_Content_Category_3_Cols extends WP_Widget {
	function __construct() {
		parent::__construct(
			'anred_content_category_3_cols',
			'Contenido - Categoría - 3 Columnas'
		);
	}
...
register_widget( 'ANRed_Content_Category_3_Cols' );